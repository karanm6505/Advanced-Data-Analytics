"""GRU baseline for the multivariate pollution forecasting task."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a GRU baseline on the multivariate pollution dataset.")
    ...
    parser.add_argument("--hidden-size", type=int, default=64, help="Hidden state dimension of the GRU.")
    parser.add_argument("--layers", type=int, default=2, help="Number of GRU layers.")
    parser.add_argument("--dropout", type=float, default=0.1, help="Dropout applied between GRU layers.")
